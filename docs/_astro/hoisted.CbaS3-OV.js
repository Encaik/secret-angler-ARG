import"./hoisted.DQrKwJ3L.js";const n=localStorage.getItem("arg_logged_in"),e=localStorage.getItem("arg_username");if(n==="true"&&e){document.getElementById("not-logged-in").style.display="none",document.getElementById("inbox-content").style.display="block",document.getElementById("inbox-user").textContent={lyu:"signal_屿",shenci:"地下三尺"}[e]||e,o(e);const t=JSON.parse(localStorage.getItem("arg_progress")||"{}");t.discoveredClues||(t.discoveredClues=[]),t.discoveredClues.includes("inbox_visited")||(t.discoveredClues.push("inbox_visited"),t.explorationProgress=(t.explorationProgress||0)+5,localStorage.setItem("arg_progress",JSON.stringify(t))),e==="lyu"&&!t.discoveredClues.includes("shenci_credentials")&&(t.discoveredClues.push("shenci_credentials"),t.explorationProgress=(t.explorationProgress||0)+5,localStorage.setItem("arg_progress",JSON.stringify(t)))}function o(t){const s=document.getElementById("inbox-messages");t==="shenci"?s.innerHTML=`
