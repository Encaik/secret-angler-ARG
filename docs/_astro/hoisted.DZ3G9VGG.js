import"./hoisted.BfHTzDNM.js";const n=localStorage.getItem("arg_logged_in"),e=localStorage.getItem("arg_username");if(n==="true"&&e){document.getElementById("not-logged-in").style.display="none",document.getElementById("inbox-content").style.display="block",document.getElementById("inbox-user").textContent={lyu:"signal_屿",shenci:"地下三尺"}[e]||e,o(e);const t=JSON.parse(localStorage.getItem("arg_progress")||"{}");t.discoveredClues||(t.discoveredClues=[]),t.discoveredClues.includes("inbox_visited")||(t.discoveredClues.push("inbox_visited"),t.explorationProgress=(t.explorationProgress||0)+5,localStorage.setItem("arg_progress",JSON.stringify(t))),e==="lyu"&&!t.discoveredClues.includes("shenci_credentials")&&(t.discoveredClues.push("shenci_credentials"),t.explorationProgress=(t.explorationProgress||0)+5,localStorage.setItem("arg_progress",JSON.stringify(t)))}function o(t){const s=document.getElementById("inbox-messages");t==="shenci"?s.innerHTML=`
        ...
        <div class="card" style="margin-bottom: 12px; border-left: 3px solid var(--color-accent); padding-left: 10px;">
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px;">
            <strong>signal_屿</strong>
            <span class="text-muted">2026-05-22 01:15</span>
          </div>
          <p style="font-size: 0.9rem; margin-bottom: 4px;">
            教务系统登进去了。85分，及格了。你那个密码提示——<strong>贺兰山拼音加06</strong>——我居然想了半天。上学期在宿舍你说的应该是同一个吧？
          </p>
          <p style="font-size: 0.9rem; margin-bottom: 4px;">
        ...
        <div class="card" style="margin-bottom: 12px;">
          ...
          <p style="font-size: 0.9rem; margin-bottom: 4px;">
            另外，我之前扫频的时候发现一个规律：<strong>信号出现的时间总是和站内推送新点位的时间高度吻合</strong>。更诡异的是，那些"异常信号"的频谱特征——用SDR拉了一下，调制模式根本不像自然天体，<strong>更像是民用无线电设备能产生的信号</strong>。
          </p>
          <p style="font-size: 0.9rem; margin-bottom: 0;">
            回头我把对比数据发你。如果这些"外星信号"是人造的，那发布它们的人目的是什么？
          </p>
        </div>
      `:s.innerHTML=`
        <div class="card" style="margin-bottom: 12px;">
        ...
        <div class="card" style="margin-bottom: 12px; border-left: 3px solid var(--color-accent); padding-left: 10px;">
          ...
          <p style="font-size: 0.9rem; margin-bottom: 4px;">
            屿哥，帮个忙——你登一下<strong>学校教务系统</strong>，帮我查查《文化遗产保护》通识课出成绩了没。山里信号太差，教务系统那个破网页半天打不开。
          </p>
          <p style="font-size: 0.9rem; margin-bottom: 4px;">
            账号点我头像进主页就能看到——就是我在导航站用的这个号。密码也一样。
          </p>
          <p style="font-size: 0.9rem; margin-bottom: 4px;">
            ……上次在宿舍不是跟你说过嘛。你该不会又忘了？
          </p>
          <p style="font-size: 0.9rem; margin-bottom: 4px;">
        ...
        <div class="card" style="margin-bottom: 12px;">
          ...
          <p style="font-size: 0.9rem; margin-bottom: 4px;">
            导航站今天又给我推了一个点位——秦岭某处的"唐代摩崖石刻"。那个坐标我太熟悉了，去年实地走过。
