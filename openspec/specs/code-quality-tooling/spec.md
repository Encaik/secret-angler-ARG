...
**Purpose**: Automated code style enforcement and formatting for the Astro + TypeScript codebase via ESLint flat config and Prettier, ensuring consistency without manual review overhead.
