...
**Purpose**: Ensure immersion quality by auditing game design terminology in visible page content, maintaining an exemption list for contextually justified usage, and verifying consistency between game design documents and code implementation.
