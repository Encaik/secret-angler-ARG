...
export const ALIEN_LOCATIONS: Location[] = [
  {
    ...
    description: '2006年以来多次记录到不明电磁信号，频率集中在1420MHz——这正是氢原子谱线频率。NASA未给出合理解释。当地居民反映夜间偶尔可见橙色光柱从天而降，持续数秒后消失。建议携带频谱分析仪前往。',
    difficulty: '中等',
  ...
  },
  {
    ...
    description: '沙漠腹地有一个废弃的军用雷达站，据称可接收到来自银河系中心的微弱信号。某次信号分析显示明显的非自然调制模式。最佳观测时间：凌晨2-4点，新月期间。',
    difficulty: '困难',
  ...
  },
  {
    ...
    description: '沿神农顶至大九湖一线，多位驴友目击到三角形飞行器无声掠过。飞行器底部有三盏白色灯呈正三角排列。2019年曾有摄像团队拍到高清画面，但原始视频神秘丢失。',
    difficulty: '中等',
  ...
  },
  {
    ...
    description: '天池西坡海拔2200米处有一平坦岩石，被圈内称为"信号台"。据说在此处架设天线可接收到来自天鹅座方向的周期性脉冲。需注意：当地气象多变，务必携带防寒装备。',
    difficulty: '中等',
  ...
  },
  {
    ...
    description: '2005年有探险队在罗布泊西北边缘发现散落的金属碎片，成分异常——含高纯度钛和未知合金。后该区域被军方封锁。如今封锁已解除，但地形复杂需四驱越野车进入。',
    difficulty: '极困难',
  ...
  },
  {
    ...
    description: '昆仑山垭口附近，射电望远镜阵列记录到规律性极强的窄带信号，周期约23分钟。天文界内部称其为"昆仑脉冲"。非专业人员可携带便携式SDR设备尝试接收。',
    difficulty: '困难',
...
export const RUINS_LOCATIONS: Location[] = [
  {
    ...
    description: '贺兰山深处发现一处未在图录中收录的岩画群。岩画内容与已知的西夏风格迥异——疑似更早期文明的遗存。图案中有酷似"天外来客"的人形图腾，与外星传说有奇妙呼应。入口隐蔽，需向导带路。',
    difficulty: '中等',
  ...
  },
  {
    ...
    description: '新平县哀牢山腹地发现疑似古滇国祭祀遗迹，石砌平台直径约15米，台上刻有复杂的天文图案。值得注意的是，图案中描绘的"星辰排列"与猎户座高度吻合。前往需穿越原始森林。',
    difficulty: '困难',
    recentVisitors: ['地下三尺'],
  ...
  },
  {
    ...
    region: '湖北·神农架',
    coordinates: { lat: 31.58, lng: 110.42 },
    description: '位于神农架核心区的一处疑似史前天文观测台。巨石排列指向冬至日出方向，与英国巨石阵有异曲同工之妙。但更诡异的是，石阵中央的"祭坛石"表面有熔化痕迹——需要极高温度才能造成。附近村民称夜间可见奇怪光芒。',
    difficulty: '困难',
  ...
  },
  {
    ...
    description: '傥骆古道某段悬崖上发现多处石刻符号，非甲骨文、非金文、非任何已知文字系统。当地文保部门认为是自然风化痕迹，但符号排列有极强规律性。建议携带拓印工具。',
    difficulty: '中等',
    recentVisitors: ['地下三尺', '废弃中'],
