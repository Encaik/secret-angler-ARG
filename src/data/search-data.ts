...
export const ARCHIVED_CONTENT: Record<string, ArchivedPost[]> = {
  ...
  '轻舟云盘': [
    ...
    },
    {
      ...
      authorUrl: '',
      date: '快照于 2026-06-02',
      content: '……监控目标 signal_屿 与 地下三尺 的私信中多次提及<strong>轻舟云盘加密共享链接</strong>。创建者shenci933，最后更新5月23日。已尝试常用密码组合均无法解密。链接为公开访问，提取码未知。若该文件夹含有关键证据，需优先获取访问权限或联系云盘服务商请求删除。<strong>备注：目标可能已将提取码告知第三方。</strong>',
      isClue: true,
    },
  ],
  '云盘': [
  ...
  '2021': [
    {
      ...
      date: '2025-06-01',
      content: '算了一下，从<strong>2021年</strong>建站到现在整整四年了。初衷很简单——给喜欢探秘的人一个交流的地方。但现在回头想想，真正推动我做这件事的原因可能没那么简单。那一年发生了很多事。有些决定你不做的后果，你承受不起第二次。这个站的存在本身就是一个答案——虽然没人知道它在回答什么问题。',
      isClue: true,
    },
  ],
  ...
  '老猫': [
    {
      ...
      authorUrl: '/user/oldcat/',
      date: '2025-08-15',
      content: '闺女放暑假，非要跟我去爬山。她妈走后这是她第一次主动说要跟我出去走走。泰山不算难，但对她这个年纪来说也不容易。到了山顶她看着日出说"<strong>妈以前也喜欢看日出</strong>吧"——我不知道怎么接。下山的时候腿都在抖，但她一路没喊累。这孩子，越来越像她妈了。',
      isClue: true,
    },
    {
      title: '关于这个站——建站四年的一些碎碎念',
    ...
    },
    {
      ...
      authorUrl: '/user/oldcat/',
      date: '2025-03-12',
      content: '路过花市买了一盆兰花。闺女问我为什么突然买花，我说春天到了嘛。其实是因为她妈以前喜欢兰花——窗台上总是摆着两盆。走了快<strong>四年</strong>了，我还是不敢跟闺女聊太多她妈的事。但有些东西不说出来心里堵得慌。也许等她再大几岁吧。',
      isClue: true,
    },
  ],
  '小雨': [
    {
      ...
      authorUrl: '/user/oldcat/',
      date: '2025-08-15',
      content: '闺女放暑假，非要跟我去爬山。她妈走后这是她第一次主动说要跟我出去走走……下山的时候腿都在抖，但她一路没喊累。这孩子，越来越像她妈了。',
      isClue: true,
    },
  ],
  '闺女': [
  ...
  '女儿': [
    {
      ...
      authorUrl: '/user/oldcat/',
      date: '2025-03-12',
      content: '路过花市买了一盆兰花。闺女问我为什么突然买花，我说春天到了嘛。其实是因为她妈以前喜欢兰花……走了快四年了。',
      isClue: true,
    },
  ],
  // ---- 氛围路人内容（纯社区真实感，isClue=false，不含谜题线索） ----
  '野花': [
    { title: '五月山花记录——金佛山', author: '风信子', authorUrl: '/user/hyacinth/', date: '2026-04-20', content: '前两天去金佛山，拍到了绶草——盘旋的。不太常见，尤其在海拔这么低的地方。可能跟今年雨水多有关系。还拍了几种兰科，回头整理一下发个合集。', isClue: false },
  ],
  '暗夜': [
    { title: '冷湖暗夜保护区——实测体验', author: '北纬37', authorUrl: '/user/lat37n/', date: '2026-05-22', content: '上周末去了冷湖。那边新划了暗夜保护区，光害地图上是全黑的。实际体验比预想的还好——银河亮得能照出影子。M31肉眼直接可见。推荐给所有玩深空的。', isClue: false },
  ],
  '薄片': [
    { title: '大别山超高压变质岩薄片分享', author: '石头记', authorUrl: '/user/stonebook/', date: '2026-04-15', content: '石榴石+蓝晶石+多硅白云母的组合。典型的超高压变质矿物组合。偏光镜下颜色太漂亮了，像教堂的彩色玻璃窗。附几张不同消光位的照片。', isClue: false },
  ],
  '废墟': [
    { title: '城郊废弃纺织厂——夜景实拍', author: '夜不收', authorUrl: '/user/nightowl/', date: '2026-05-18', content: '昨晚去了城郊那个废弃纺织厂。车间里全是蜘蛛网和锈掉的机器，月光从天窗照进来刚好打在一条旧传送带上。ISO3200，30秒，f/2.8。出来效果绝了。', isClue: false },
  ],
  '钓鱼': [
    { title: '金沙江最近水浑得厉害', author: '大江', authorUrl: '/user/bigriver/', date: '2026-05-10', content: '金沙江这段水又浑了。上游肯定在施工。蹲了三个小时就上了两条白条，都不够猫吃的。以前这里一个下午能拉十几条。变化太快了。', isClue: false },
  ],
  '老房子': [
    { title: '白果村清代石拱桥——最后一张照片', author: '慢邮差', authorUrl: '/user/slowpost/', date: '2026-05-12', content: '白果村那座清代的石拱桥上周被拆了。说是危桥，其实也就是侧面裂了一道缝。拆完之后原地修了一座水泥平桥。跑了十五年这条线的邮路，以后过这里就看不到那个桥了。', isClue: false },
  ],
};
