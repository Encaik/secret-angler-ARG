...
export const LYU_UPDATES: UserUpdate[] = [
  ...
  },
  {
    id: 'lyu-update-004',
    userId: 'lyu',
    content: '去了站里推的两个"信号热点"。现场都有人类活动痕迹——篝火、烟头、设备残片。不像探秘者留下的。太新了。',
    date: '2024-08-20',
  ...
  },
  {
    id: 'lyu-update-006',
    userId: 'lyu',
    content: '站里新推的凤凰山点位我去过了。没有目击报告里说的信号塔。只有一个废弃微波中继站。这个站的信息源到底是谁在维护？',
    date: '2024-08-08',
  },
  {
    id: 'lyu-update-007',
  ...
  },
  {
    id: 'lyu-update-009',
    userId: 'lyu',
    content: '暑假去神农架蹲几天。UFO走廊最近报告太多，而且好几个是不同人在同一时段看到的。带设备去守。',
    date: '2024-06-30',
  },
  {
    id: 'lyu-update-010',
    userId: 'lyu',
    content: '刚注册。站里信息质量看起来还可以，至少比营销号强。先观望。',
    date: '2024-06-15',
  },
];
...
export const LYU_ARTICLES: UserArticle[] = [
  {
    id: 'lyu-article-001',
    userId: 'lyu',
    title: '凤凰山1420MHz异常信号全频段分析（2024.08更新）',
  ...
  },
  {
    id: 'lyu-article-002',
    userId: 'lyu',
    title: '全国外星目击高发区坐标数据集（47点·2023-2024）',
...
export const SHENCI_UPDATES: UserUpdate[] = [
  ...
  },
  {
    ...
    userId: 'shenci',
    content: '站里又推了一个"冷门秘境"给我——秦岭某处未记录摩崖。查了坐标，那个位置我去过。没有任何石刻。这个站在系统性地编造假点位。为什么？能从中得到什么？',
    date: '2024-08-25',
  ...
  },
  {
    ...
    userId: 'shenci',
    content: '越想越不对。最近去的几个推荐点都有人为活动痕迹——新鲜篝火、塑料瓶、被踩出来的小路。但问当地人都说那里极少有人去。这些痕迹是谁留下的？',
    date: '2024-08-18',
  ...
  },
  {
    ...
    userId: 'shenci',
    content: '重看了之前十个点位的现场照片。每个"秘境"都有一些人为布置的痕迹——不自然的磨损、整齐排列的石头、看起来很旧的金属碎片。不像自然遗迹。更像……布景。',
    date: '2024-08-10',
    clueTag: 'stage_setup',
  },
  {
    ...
    userId: 'shenci',
    content: '如果"布景"这个猜测成立——那就不是一个站信息有误的问题了。是有组织地在某个地方复刻假的"秘境"。但为什么？花这么多成本在深山里搭布景，图什么？',
    date: '2024-08-05',
  },
  {
...
export const SHENCI_ARTICLES: UserArticle[] = [
  {
    ...
    excerpt: '2024年8月实地探访。该岩画群未出现在任何公开文物图录中。风格与西夏时期作品有显著差异——线条更粗犷，图案更抽象。编号HL-07的岩画描绘了头戴"圆盔"的人形与星体图案。附手绘图37幅、GPS坐标。',
    date: '2024-09-02',
    category: 'ruins',
  ...
  },
  {
    ...
    excerpt: '最近对这个站的信息源产生了严重怀疑。多次实地探访发现站内推荐的"冷门秘境"存在系统性的描述失实。这不是偶发的信息错误——错误的模式太有规律了。本文记录了我的发现过程。如果你也发现过类似问题，私信我。有些东西藏在表面之下。',
    date: '2024-08-25',
    category: 'ruins',
    clueTag: 'site_doubts',
  },
